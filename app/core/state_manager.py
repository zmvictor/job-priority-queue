...
class HAJobStateManager:
    ...
    async def transition_to_running(self, job: Job) -> Optional[Job]:
        ...
        async with get_session() as session:
            try:
                ...
                job = Job.model_validate({
                    ...
                    'metadata': json.loads(updated_job.job_metadata, object_hook=lambda d: {k: v for k, v in d.items()}),
    ...
    async def preempt_job(self, job: Job) -> Job:
